...
2. Temporal Smoothness: It applies a *k*-th order trend-filtering penalty ($\mathvf{D}$) to capture structured paths and identify sudden "level shifts" or changing trends.
