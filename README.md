...
1. Data Fidelity: It ensures the recovered signal, when averaged over five years (via convolution matrix $\mathbf{M}$, matches the observed ACS estimates, weighted by their precision ($W$).
